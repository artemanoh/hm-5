...
function wrongKey(expected, pressed) {
    (0, _core.error)({
        text: `\u{41F}\u{43E}\u{43C}\u{438}\u{43B}\u{43A}\u{430}. \u{422}\u{440}\u{435}\u{431}\u{430}: "${expected}", \u{432}\u{438} \u{43D}\u{430}\u{442}\u{438}\u{441}\u{43D}\u{443}\u{43B}\u{438}: "${pressed}"`,
        delay: 5000
    });
}
keyDisplay.textContent = keys[currentKeyIndex];
document.addEventListener("keydown", (event)=>{
    ...
    if (pressedKey === "Tab") event.preventDefault();
    const expectedKey = keys[currentKeyIndex];
    if (pressedKey === expectedKey) {
        currentKeyIndex++;
        updateKeyDisplay();
    } else wrongKey(expectedKey, pressedKey);
});
...
},{}],"grIyt":[function() {},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire2465", {})

//# sourceMappingURL=hm-5.31b563d9.js.map
